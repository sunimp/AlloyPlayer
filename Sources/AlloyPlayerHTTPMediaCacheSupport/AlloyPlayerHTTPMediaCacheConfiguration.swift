//
//  AlloyPlayerHTTPMediaCacheConfiguration.swift
...
/// HTTPMediaCache 集成配置。
public struct AlloyPlayerHTTPMediaCacheConfiguration: Equatable, Sendable {
    /// 默认配置：随机端口、绑定 localhost、不附加源站请求头。
    public static let `default` = AlloyPlayerHTTPMediaCacheConfiguration()
